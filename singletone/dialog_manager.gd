...
@onready var dialog_box1 = preload("res://prefabs/dialog_box.tscn")
...
func show_text():
	dialog_box = dialog_box1.instantiate()
...
func _unhandled_input(event):
	if(event.is_action_pressed("advance_message") && is_massage_active && can_advance_message):
